 ...
 *
 */
namespace gamboamartin\dveducacion\controllers;
...
class controlador_adm_session extends \gamboamartin\controllers\controlador_adm_session {
    ...
    public function avanzado(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
    ...
    public function basico(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
    ...
    public function intermedio(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
    ...
    public function nosotros(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
    ...
    public function pregunta(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
        /*$template =  parent::inicio($aplica_template, false); // TODO: Change the autogenerated stub
        if(errores::$error){
            return $this->retorno_error(mensaje:  'Error al generar template',data: $template, header: $header, ws: $ws);
    ...
    public function contactos(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
        /*$template =  parent::inicio($aplica_template, false); // TODO: Change the autogenerated stub
        if(errores::$error){
            return $this->retorno_error(mensaje:  'Error al generar template',data: $template, header: $header, ws: $ws);
    ...
    public function quienes(bool $aplica_template = false, bool $header = true, bool $ws = false): string|array
    {
        /*$template =  parent::inicio($aplica_template, false); // TODO: Change the autogenerated stub
        if(errores::$error){
            return $this->retorno_error(mensaje:  'Error al generar template',data: $template, header: $header, ws: $ws);
